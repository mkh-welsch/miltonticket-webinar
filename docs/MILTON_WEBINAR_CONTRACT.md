...
- Einladungen, Recording-Consent und Recording-Löschung werden über `/invitations`, `/recording-consent` und `/recording/delete` im Milton-CRM geführt; diese App hält keine eigene Teilnehmer- oder CRM-Wahrheit.
